...
def get_url():
    ...
    # https://api.eu-gb.speech-to-text.watson.cloud.ibm.com/instances/250415ef-a2b6-4487-a6f5-e344d63fb2a3
    return ("wss://{}/speech-to-text/api/v1/recognize"
           "?model=en-GB_BroadbandModel").format(host)

    # return "https://api.eu-gb.speech-to-text.watson.cloud.ibm.com/instances/250415ef-a2b6-4487-a6f5-e344d63fb2a3"
